...
// In release version: data-widget="index" should be data-widget="widget"

describe('AutoRender', function() {
  it('autoRenderAll', function(done) {
    var dom = $('<div data-widget="index" data-class-name="widget" data-id="test1"></div>');
  ...
  it('autoRender trigger', function(done) {
    ...
    var trigger = $('<div id="test2" data-widget="index" data-class-name="widget" data-widget-role="trigger" data-element="#element"></div>');
  ...
  it('autoRender template', function(done) {
    ...
    var trigger = $('<div id="test3" data-widget="index" data-widget-role="trigger" data-template="#tpl"></div>');
    trigger.appendTo(document.body);
    Widget.autoRenderAll(function() {
